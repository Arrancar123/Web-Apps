...
<?php
    ...
    if(isset($_POST['forgotpass'])){
        ...
        $confirmpass = md5($_POST['newconfirm']);	
			...
			if($password == $confirmpass){
				$sql = "UPDATE register SET password = '$password', confirmpass = '$confirmpass' WHERE email = '$username'";
	...
	<div class = 'container-fluid'>
        ...
        <div class="row">
            <div class="updates2 col-md-10 col-md-offset-1">
                ...
                <a href="WebApp%20Project.php"><button type="button" class="back">Back to Login</button></a>
                <hr>
                <div class="row">
